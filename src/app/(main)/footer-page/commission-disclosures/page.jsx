    ...
    return (
        <div className={`${styles.footerpage} `}>
            ...
            <div className="max-w-screen-xl mx-auto main-section">
                ...
                <h2 className="text-xl font-bold text-primary mb-2 mt-2">Commission Disclosure under SEBI Circular SEBI/IMD/CIR No.4 /168230/09</h2>
                    ...
                    <TableBody>
                        {commissionData.map((item, index) => (
                            <TableRow key={index} className="border-b">
                                <TableCell className="px-4 py-3 font-semibold bg-primary text-primary-foreground">{item.scheme}</TableCell>
                                <TableCell className="px-4 py-3 bg-primary text-primary-foreground">{item.trail1}</TableCell>
                                <TableCell className="px-4 py-3 bg-primary text-primary-foreground">{item.trail2}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
